...
export const mockProduk: Produk[] = [
  { id: 'p-1', nama: 'Pupuk Urea 50kg', sku: 'PUP-001', kategori: 'Pupuk', satuan: 'karung', hargaBeli: 85000, hargaJual: 110000, stok: 120, thresholdStok: 20, statusAktif: true, statusStok: 'normal', supplierIds: ['sup-1'], createdAt: d(90), updatedAt: now },
  { id: 'p-2', nama: 'Pupuk NPK Mutiara', sku: 'PUP-002', kategori: 'Pupuk', satuan: 'kg', hargaBeli: 12000, hargaJual: 16000, stok: 8, thresholdStok: 10, statusAktif: true, statusStok: 'menipis', supplierIds: ['sup-1'], createdAt: d(80), updatedAt: now },
  { id: 'p-3', nama: 'Pestisida Roundup 1L', sku: 'PES-001', kategori: 'Pestisida', satuan: 'botol', hargaBeli: 55000, hargaJual: 75000, stok: 35, thresholdStok: 5, statusAktif: true, statusStok: 'normal', supplierIds: ['sup-2'], createdAt: d(70), updatedAt: now },
  { id: 'p-4', nama: 'Benih Padi IR64', sku: 'BEN-001', kategori: 'Benih', satuan: 'kg', hargaBeli: 15000, hargaJual: 22000, stok: 0, thresholdStok: 10, statusAktif: true, statusStok: 'habis', supplierIds: ['sup-3'], createdAt: d(60), updatedAt: now },
  { id: 'p-5', nama: 'Sprayer Manual 16L', sku: 'ALT-001', kategori: 'Alat & Mesin', satuan: 'unit', hargaBeli: 125000, hargaJual: 175000, stok: 15, thresholdStok: 3, statusAktif: true, statusStok: 'normal', supplierIds: ['sup-2', 'sup-4'], createdAt: d(50), updatedAt: now },
  { id: 'p-6', nama: 'Pupuk Kandang Organik', sku: 'PUP-003', kategori: 'Pupuk', satuan: 'karung', hargaBeli: 25000, hargaJual: 35000, stok: 60, thresholdStok: 15, statusAktif: true, statusStok: 'normal', supplierIds: ['sup-1', 'sup-3'], createdAt: d(40), updatedAt: now },
  { id: 'p-7', nama: 'Pupuk Kompos 10kg', sku: 'PUP-004', kategori: 'Pupuk', satuan: 'karung', hargaBeli: 18000, hargaJual: 26000, stok: 45, thresholdStok: 10, statusAktif: true, statusStok: 'normal', supplierIds: ['sup-3'], createdAt: d(30), updatedAt: now },
]
...
export const mockShift: Shift[] = [
  { id: 'sh-1', kasirId: 'u-3', kasirNama: 'Siti Kasir', cabangId: 'toko-1', cabangNama: 'Toko Utama', modalAwal: 500000, saldoAkhir: 3300000, totalTransaksi: 12, totalPendapatan: 4250000, totalTunai: 2800000, totalNonTunai: 1450000, totalDiskon: 150000, status: 'Selesai', mulaiAt: dh(1, 8), selesaiAt: dh(1, 16), catatanPenutupan: 'Shift berjalan normal.', createdAt: dh(1, 8), updatedAt: dh(1, 16) },
  { id: 'sh-2', kasirId: 'u-3', kasirNama: 'Siti Kasir', cabangId: 'toko-1', cabangNama: 'Toko Utama', modalAwal: 500000, saldoAkhir: 2350000, totalTransaksi: 9, totalPendapatan: 3100000, totalTunai: 1900000, totalNonTunai: 1200000, totalDiskon: 80000, status: 'Selesai', mulaiAt: dh(2, 8), selesaiAt: dh(2, 16), createdAt: dh(2, 8), updatedAt: dh(2, 16) },
  { id: 'sh-3', kasirId: 'u-5', kasirNama: 'Rina Kasir', cabangId: 'toko-2', cabangNama: 'Toko Selatan', modalAwal: 500000, saldoAkhir: 1950000, totalTransaksi: 7, totalPendapatan: 2750000, totalTunai: 1500000, totalNonTunai: 1250000, totalDiskon: 50000, status: 'Selesai', mulaiAt: dh(1, 8), selesaiAt: dh(1, 16), createdAt: dh(1, 8), updatedAt: dh(1, 16) },
  { id: 'sh-4', kasirId: 'u-3', kasirNama: 'Siti Kasir', cabangId: 'toko-1', cabangNama: 'Toko Utama', modalAwal: 500000, saldoAkhir: 3630000, totalTransaksi: 15, totalPendapatan: 5800000, totalTunai: 3200000, totalNonTunai: 2600000, totalDiskon: 200000, status: 'Selesai', mulaiAt: dh(3, 8), selesaiAt: dh(3, 16), catatanPenutupan: 'Ramai, banyak pembelian pupuk.', createdAt: dh(3, 8), updatedAt: dh(3, 16) },
  { id: 'sh-5', kasirId: 'u-5', kasirNama: 'Rina Kasir', cabangId: 'toko-2', cabangNama: 'Toko Selatan', modalAwal: 500000, saldoAkhir: 1700000, totalTransaksi: 5, totalPendapatan: 1800000, totalTunai: 1200000, totalNonTunai: 600000, totalDiskon: 0, status: 'Selesai', mulaiAt: dh(2, 8), selesaiAt: dh(2, 16), createdAt: dh(2, 8), updatedAt: dh(2, 16) },
  { id: 'sh-6', kasirId: 'u-3', kasirNama: 'Siti Kasir', cabangId: 'toko-1', cabangNama: 'Toko Utama', modalAwal: 500000, saldoAkhir: null, totalTransaksi: 3, totalPendapatan: 980000, totalTunai: 980000, totalNonTunai: 0, totalDiskon: 0, status: 'Aktif', mulaiAt: dh(0, 8), selesaiAt: null, createdAt: dh(0, 8), updatedAt: dh(0, 8) },
]
...
export const mockPergerakanStok: PergerakanStok[] = [
  { id: 'pg-s-1', produkId: 'p-1', produkNama: 'Pupuk Urea 50kg', produkSku: 'PUP-001', cabangId: 'gudang-1', cabangNama: 'Gudang Pusat', jenis: 'masuk', jumlah: 50, stokSebelum: 70, stokSesudah: 120, referensi: 'PO-2026-001', userId: 'demo-admin', userNama: 'Admin Demo', catatan: 'Penerimaan PO dari PT Agro Makmur', createdAt: d(15) },
  { id: 'pg-s-2', produkId: 'p-2', produkNama: 'Pupuk NPK Mutiara', produkSku: 'PUP-002', cabangId: 'gudang-1', cabangNama: 'Gudang Pusat', jenis: 'masuk', jumlah: 100, stokSebelum: 0, stokSesudah: 100, referensi: 'PO-2026-001', userId: 'demo-admin', userNama: 'Admin Demo', catatan: 'Penerimaan PO dari PT Agro Makmur', createdAt: d(15) },
  { id: 'pg-s-3', produkId: 'p-6', produkNama: 'Pupuk Kandang Organik', produkSku: 'PUP-003', cabangId: 'gudang-1', cabangNama: 'Gudang Pusat', jenis: 'masuk', jumlah: 100, stokSebelum: 0, stokSesudah: 100, referensi: 'PO-2026-004', userId: 'demo-admin', userNama: 'Admin Demo', catatan: 'Penerimaan PO dari PT Agro Makmur', createdAt: d(12) },
  { id: 'pg-s-4', produkId: 'p-3', produkNama: 'Pestisida Roundup 1L', produkSku: 'PES-001', cabangId: 'gudang-1', cabangNama: 'Gudang Pusat', jenis: 'masuk', jumlah: 20, stokSebelum: 17, stokSesudah: 37, referensi: 'PO-2026-004', userId: 'demo-admin', userNama: 'Admin Demo', catatan: 'Penerimaan PO dari CV Pestisida Jaya', createdAt: d(12) },
  { id: 'pg-s-5', produkId: 'p-1', produkNama: 'Pupuk Urea 50kg', produkSku: 'PUP-001', cabangId: 'gudang-1', cabangNama: 'Gudang Pusat', jenis: 'keluar', jumlah: 10, stokSebelum: 120, stokSesudah: 110, referensi: 'TS-2026-002', userId: 'demo-admin', userNama: 'Admin Demo', catatan: 'Transfer ke Toko Utama', createdAt: d(8) },
  { id: 'pg-s-6', produkId: 'p-6', produkNama: 'Pupuk Kandang Organik', produkSku: 'PUP-003', cabangId: 'gudang-1', cabangNama: 'Gudang Pusat', jenis: 'keluar', jumlah: 10, stokSebelum: 68, stokSesudah: 58, referensi: 'TS-2026-002', userId: 'demo-admin', userNama: 'Admin Demo', catatan: 'Transfer ke Toko Utama', createdAt: d(8) },
  { id: 'pg-s-7', produkId: 'p-2', produkNama: 'Pupuk NPK Mutiara', produkSku: 'PUP-002', cabangId: 'gudang-1', cabangNama: 'Gudang Pusat', jenis: 'penyesuaian', jumlah: -2, stokSebelum: 10, stokSesudah: 8, referensi: null, userId: 'demo-admin', userNama: 'Admin Demo', catatan: 'Stok rusak saat penyimpanan', alasan: 'Rusak', createdAt: d(6) },
  { id: 'pg-s-8', produkId: 'p-1', produkNama: 'Pupuk Urea 50kg', produkSku: 'PUP-001', cabangId: 'toko-1', cabangNama: 'Toko Utama', jenis: 'penyesuaian', jumlah: -10, stokSebelum: 130, stokSesudah: 120, referensi: 'SO-2026-001', userId: 'u-2', userNama: 'Budi Manajer', catatan: 'Koreksi hasil stok opname', alasan: 'Koreksi', createdAt: d(4) },
  { id: 'pg-s-9', produkId: 'p-3', produkNama: 'Pestisida Roundup 1L', produkSku: 'PES-001', cabangId: 'toko-1', cabangNama: 'Toko Utama', jenis: 'penyesuaian', jumlah: 2, stokSebelum: 35, stokSesudah: 37, referensi: 'SO-2026-001', userId: 'u-2', userNama: 'Budi Manajer', catatan: 'Koreksi hasil stok opname', alasan: 'Koreksi', createdAt: d(4) },
  { id: 'pg-s-10', produkId: 'p-5', produkNama: 'Sprayer Manual 16L', produkSku: 'ALT-001', cabangId: 'toko-1', cabangNama: 'Toko Utama', jenis: 'masuk', jumlah: 5, stokSebelum: 10, stokSesudah: 15, referensi: 'TS-2026-003', userId: 'u-2', userNama: 'Budi Manajer', catatan: 'Transfer dari Gudang Pusat', createdAt: d(3) },
]

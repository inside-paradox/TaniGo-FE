      ...
      {elemen.map((el) => {
        ...
        return (
          <div
            key={el.id}
            className={cn(
              'absolute flex flex-col items-center justify-center rounded-lg border-2 p-1 text-center',
          ...
          >
            ...
            <span className="max-w-full truncate text-[11px] font-bold leading-tight sm:text-sm">{el.kode}</span>
          </div>
        )
      })}
    </div>
